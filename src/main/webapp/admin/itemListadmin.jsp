...
<title>상품 목록</title>
  <script type="text/javascript">
     function itemwrite(){
    	 document.location = "ItemWriteMove"
     }
...
<body>
  <c:import url="adminHeader.jsp"></c:import>
   <input type="button" class="btn" value="상품 추가" onclick="itemwrite()"><hr>

   <form name="Item" action="itemListadmin">
		...
		<tbody>
         ...
         %>
         	<tr>
               ...
               <td><a href="itemDetailadmin?trvidx=<%=item.getTrv_idx()%>"><%=item.getTrv_name() %></a></td>
